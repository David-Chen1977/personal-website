...
export const articles: Article[] = [
  ...
  // ── 算电协同 ──
  { slug: 'yi-wen-du-dong-suan-dian-xie-tong-chan-ye-tu-pu', title: '一文读懂算电协同产业图谱', desc: '万字长文拆解算电协同全产业链——从底层逻辑到六大赛道、从政策红利的标杆项目到投资机会图谱，为想进入和了解这个赛道的人提供一份地图式的指引和攻略。', date: '2026-06-28', readTime: '约 25 分钟阅读', category: '算电协同', tags: ['算电协同', '产业图谱', '数据中心', '绿电直连', '液冷散热', '虚拟电厂', '算力调度', 'AI电力交易', '电改2.0', '东数西算', 'PE投资', '产业链'] },
];
